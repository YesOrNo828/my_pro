                            ...
                            switch (qunar.getDepDate()) {
                                case "2017-04-12":
                                    if (price != lastPrice[0]) {
                                        sb.append(qunar.getDepDate() + "\t" + qunar.getPrice()).append(",前" + nextHour + "小时价格：").append(lastPrice[0]).append("<br>");
                                        lastPrice[0] = price;
                                        shouldSend[0] = true;
                                        break;
                                    }
                                case "2017-04-13":
                                    if (price != lastPrice[1]) {
                                        shouldSend[0] = true;
                                        sb.append(qunar.getDepDate() + "\t" + qunar.getPrice()).append(",上个小时价格：").append(lastPrice[1]).append("<br>");
                                        lastPrice[1] = price;
                                        break;
                                    }
                                default:
                                    sb.append(qunar.getDepDate() + "\t" + qunar.getPrice()).append("<br>");
                                    break;
                            }
